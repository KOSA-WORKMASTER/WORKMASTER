        ...
        <div class="search-input-container">
            ...
            <div class="search-select-type-wrapper btn-group btn-group-toggle" data-toggle="buttons">
                <label class="btn btn-outline-secondary active">
                    <input type="radio" name="select-type" id="edit" value="1" checked> 재고 추가
                </label>
                <label class="btn btn-outline-secondary">
                    <input type="radio" name="select-type" id="delete" value="2"> 재고 삭제
                </label>
            </div>
            <div class="search-result-into-container">
                ${memberList.size()}개의 상품이 검색되었습니다       <!-- 재고 리스트 필요함 -->
            </div>
        </div>
