							...
							<form action="/stockManage/stock" method="post" name="stockForm"
								...
								<div class="stock add">
									...
									<br> <label>재고명</label> <br> <input type="text"
										class="form-control" placeholder="재고명" aria-label="stockName"
										aria-describedby="basic-addon1"> <br> <label>품목명</label>
									...
									<label>단가</label> <br> <input type="text"
										class="form-control" placeholder="단가" aria-label="unitPrice"
										aria-describedby="basic-addon1"> <br> <label>최근입고일자</label>
